...
//doble for para en primer lugar recorrer las peliculas y posteriormente el array de categorias
for (const movie of movies){
    for (const category of movie.categories){
        //Si la categoria no esta, la añadimos al array
